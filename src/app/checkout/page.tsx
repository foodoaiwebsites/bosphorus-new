...
const Page = ({}) => {
    ...
    if (!restaurant?.onlineOrder) {
        return (
            <main className="flex h-full min-h-screen w-full items-center justify-center bg-menubackground">
                <div className="text-2xl text-menusecondary font-semibold">Online order is currently not available</div>
            </main>
        );
    }
    ...
    return (
        <main className="relative flex h-full w-full flex-col">
            ...
            <div className="flex h-full w-full flex-col items-center justify-center bg-menubackground">
                <Checkout />
            </div>
        </main>
    );
