        ...
        <div className="px-5">
          {modifiers && (
            <div className="rounded-xl bg-itembackground px-5 py-6">
              <p className="grid grid-cols-2 items-center justify-start gap-1 font-manrope text-sm text-menusecondary">
                {modifiers &&
                  modifiers.length > 0 &&
                  Object.entries(
                    modifiers.reduce(
          ...
          <div className="flex w-full items-center justify-center gap-4 px-5 py-5">
            ...
            >
              <Button
                ...
                className="w-full border-[1px] border-menusecondary text-menuforeground hover:bg-menusecondary hover:text-menubackground"
              >
                I&apos;ll Choose
              </Button>
            </Link>
            <MenuItemDrawer item={item} setChoose={setOpen}>
              <Button
                variant="outline"
                className="w-1/2 border-[1px] border-menusecondary text-menuforeground hover:bg-menusecondary hover:text-menubackground md:hidden"
              >
                I&apos;ll Choose
              </Button>
            </MenuItemDrawer>
